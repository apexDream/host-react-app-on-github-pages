  ...
  return( 
    <nav className='flex flex-col items-center xl:justify-center gap-y-4 fixed h-max bottom-0
      ...
      <div className='flex w-full xl:flex-col items-center justify-between xl:justify-center 
                        gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] bg-red-200/10 xl:h-max py-8
            ...
            >
              {/* tooltip */}
                <div className='absolute pr-14 right-0 hidden xl:group-hover:flex'>
                  ...
                  rounded-[3px]'>
                    <div className='text-[12px] leading-none font-semibold capitlize'>{link.name}</div>
                  </div>
                  {/* triangle */}
                  <div className='border-solid border-l-white border-l-8 border-y-transparent border-y-[12px]
                  border-r-0 absolute -right-[-49px]'></div>
                </div>
              <div>{link.icon}</div>
              </Link>
          ) 
